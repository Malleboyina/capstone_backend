...
public class WishListController {
        ...
        public ResponseEntity<WishList> addWishList(@PathVariable String productId,@PathVariable String email) {
       ...
       @DeleteMapping("/delete/{productId}/{email}")
        public ResponseEntity<Boolean> deletWishList(@PathVariable String productId,@PathVariable String email ){
